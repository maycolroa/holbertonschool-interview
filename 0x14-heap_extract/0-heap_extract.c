...
/**
 * tree_height - retrieves height from a binary tree
...
/**
 * tree_size_h - retrieves total size
 * @tree: pointer to the root node
 * Return: total heigh, 0
 */
...
/**
 * _preorder - use pre-order traversal to go into binary tree
 * @tree: root node pointer
 * @node: last node pointer
